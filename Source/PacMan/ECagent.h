...
private:
	...
	static const int kNumActions = 4; //0,1,2,3,4 
	static const int kSaveEpisodes = 50;
	static const std::string kQECtableFilename;
	static const std::string kSummaryFilename;
	static const std::string kKDtreeFilename;
	static const bool bEmbedding = 0; //0 == random projection, 1 == VAE
